...
Code smells are indicators of potential issues in code design that suggest refactoring is needed. Common code smells include:

- **Duplicated Code**: Same or similar code repeated in multiple places
- **Long Methods**: Functions doing too many things (typically >20 lines)
- **Large Classes**: Classes with too many responsibilities
- **Complex Conditionals**: Deeply nested if/else statements
- **Dead Code**: Unused variables, functions, or parameters
- **Poor Naming**: Unclear or misleading variable/function names
- **Magic Numbers**: Unexplained numeric constants in code

When you encounter these patterns, use AI tools to help identify and refactor them systematically.
