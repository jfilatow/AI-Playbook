...
### [Allowed Tools for MYOB Pilot](MYOB-approved-tools.md)
AI tools vetted for use in the MYOB pilot, with guidance on privacy settings and compliance.
...
1. Start with the **Allowed Tools for MYOB Pilot** to choose compliant AI tools
...
The **Contributing** guide shows you how to share your own prompts, rules, and improvements with the wider MYOB community. 